            ...
            fallback={
              <>
                ...
                <p class="auth-callback__text">
                  The link may have expired. Please return to CaTune and request a new sign-in link.
                </p>
              </>
            }
          >
            {(u) => (
              <>
                ...
                <p class="auth-callback__text">
                  You can close this tab and return to the CaTune tab where you requested sign-in.
